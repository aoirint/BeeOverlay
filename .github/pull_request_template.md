...
pull request. For example, mention review focus, trade-offs, compatibility
risks, generated outputs, packaging concerns, or areas that need extra
attention for reasons other than AI assistance.
-->
...
<!--
List the checks you ran and their results. Include commands, manual in-game
checks, screenshots, or videos when relevant. For docs-only changes, mention
proofreading, link checks, formatting checks, or "Not run - docs only."
...
or videos. Do not present AI-performed review, inspection, editing,
verification, or other work as "manual".
-->

## Checklist

<!--
Check this item before submitting. Pull requests cannot be merged without
Contribution License Agreement confirmation.
-->
